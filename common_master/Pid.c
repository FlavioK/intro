...
static void PID_PrintHelp(const CLS1_StdIOType *io) {
	...
	CLS1_SendHelpStr((unsigned char*) "  speed (L|R) (p|d|i|w) <value>",
			(unsigned char*) "Sets P, D, I or anti-windup position value\r\n",
			io->stdOut);
	CLS1_SendHelpStr((unsigned char*) "  pos (L|R) (p|d|i|w) <value>",
			(unsigned char*) "Sets P, D, I or anti-windup position value\r\n",
			io->stdOut);
}
...
void PID_Init(void) {
	...
	speedLeftConfig.pFactor100 = 1200;
	...
	speedRightConfig.pFactor100 = 1200;
